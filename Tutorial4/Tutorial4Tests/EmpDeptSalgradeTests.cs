...
public class EmpDeptSalgradeTests
{
    ...
    // SQLs SELECT * FROM Emp WHERE Job = 'SALESMAN';
    [Fact]
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var tmp = depts.Where(d => d.Loc == "CHICAGO").ToList();
        var result = emps.Where(e => e.DeptNo == tmp[0].DeptNo).ToList();
